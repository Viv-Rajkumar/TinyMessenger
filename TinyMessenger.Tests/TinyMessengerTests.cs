...
namespace TinyMessenger.Tests {
  ...
  public class TinyMessengerTests {
    ...
    public void Subscribe_ValidDeliverAction_DoesNotThrow() {
      ...
      messenger.Subscribe(UtilityMethods.FakeDeliveryAction<TestMessage>);
    }
    ...
    public void SubScribe_ValidDeliveryAction_ReturnsRegistrationObject() {
      ...
      var output = messenger.Subscribe(UtilityMethods.FakeDeliveryAction<TestMessage>);
    ...
    public void Subscribe_ValidDeliverActionWIthStrongReferences_DoesNotThrow() {
      ...
      messenger.Subscribe(UtilityMethods.FakeDeliveryAction<TestMessage>, true);
    }
    ...
    public void Subscribe_ValidDeliveryActionAndFilter_DoesNotThrow() {
      ...
      messenger.Subscribe(UtilityMethods.FakeDeliveryAction<TestMessage>, UtilityMethods.FakeMessageFilter<TestMessage>);
    }
    ...
    public void Subscribe_NullDeliveryAction_Throws() {
      ...
      messenger.Subscribe(null, UtilityMethods.FakeMessageFilter<TestMessage>);
    }
    ...
    public void Subscribe_NullFilter_Throws() {
      ...
      messenger.Subscribe(UtilityMethods.FakeDeliveryAction<TestMessage>, null, new TestProxy());
    }
    ...
    public void Subscribe_NullProxy_Throws() {
      ...
      messenger.Subscribe(
        UtilityMethods.FakeDeliveryAction<TestMessage>,
        UtilityMethods.FakeMessageFilter<TestMessage>,
        null);
    }
    ...
    public void Unsubscribe_PreviousSubscription_DoesNotThrow() {
      var messenger = UtilityMethods.GetMessenger();
      var subscription = messenger.Subscribe(
        UtilityMethods.FakeDeliveryAction<TestMessage>,
        UtilityMethods.FakeMessageFilter<TestMessage>);
    ...
    public void Subscribe_PreviousSubscription_ReturnsDifferentSubscriptionObject() {
      var messenger = UtilityMethods.GetMessenger();
      var sub1 = messenger.Subscribe(
        UtilityMethods.FakeDeliveryAction<TestMessage>,
        UtilityMethods.FakeMessageFilter<TestMessage>);
      var sub2 = messenger.Subscribe(
        UtilityMethods.FakeDeliveryAction<TestMessage>,
        UtilityMethods.FakeMessageFilter<TestMessage>);
    ...
    public void Subscribe_CustomProxyNoFilter_DoesNotThrow() {
      ...
      messenger.Subscribe(UtilityMethods.FakeDeliveryAction<TestMessage>, proxy);
    }
    ...
    public void Subscribe_CustomProxyNoFilterStrongReference_DoesNotThrow() {
      ...
      messenger.Subscribe(UtilityMethods.FakeDeliveryAction<TestMessage>, true, proxy);
    }
    ...
    public void Publish_CustomProxyNoFilter_UsesCorrectProxy() {
      ...
      ReferenceEquals(message, proxy.Message);
    }
    ...
    public void Publish_SubscribedMessageNoFilter_GetsActualMessage() {
      ...
      ReferenceEquals(payload, receivedMessage);
    }
...
#pragma warning restore 219
    ...
    public void CancellableGenericTinyMessage_Publish_DoesNotThrow() {
      var messenger = UtilityMethods.GetMessenger();
#pragma warning disable 219
      messenger.Publish(new CancellableGenericTinyMessage<string>(this, "Testing", () => { bool test = true; }));
#pragma warning restore 219
    }
